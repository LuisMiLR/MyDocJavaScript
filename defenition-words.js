...
L'initialisation d'une variable se produit lorsque vous attribuez une valeur initiale à une variable pour la première fois. Cela se produit généralement 
lors de la déclaration de la variable. Par exemple :
let x = 10;

Affectation de variables: 
L'affectation de variables, se produit lorsque vous attribuez une nouvelle valeur à une variable qui a déjà été déclarée et initialisée. Par exemple :
x = 20;
...
CORS, ou Cross-Origin Resource Sharing, est un mécanisme qui permet aux navigateurs web d'autoriser les requêtes HTTP entre des origines (domaines) différents, 
renforçant ainsi la sécurité tout en facilitant l'accès à des ressources distantes. 
*/
