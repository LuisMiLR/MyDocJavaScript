...
Les valeurs primitives en JavaScript sont des types de données qui ne sont pas des objets et qui ont une représentation directe en mémoire. 
Les valeurs primitives sont immuables, ce qui signifie qu'elles ne peuvent pas être modifiées une fois qu'elles ont été créées. 
Voici les six types de valeurs primitives en JavaScript :
...
7 bigint:  est un nouveau type de données introduit dans ECMAScript 2020 (également appelé ES11). Il est utilisé pour représenter des entiers de taille arbitraire, 
ce qui signifie qu'il peut stocker des entiers de taille supérieure à ce que le type de données Number standard peut gérer ()
