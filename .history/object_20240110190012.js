...
// ****Objet.valeurs()****
// Dans la leçon précédente, nous avons vu que nous pouvons accéder aux valeurs d'un objet en parcourant les clés, puis en accédant dynamiquement aux clés. Cela fonctionne si vous devez accéder à la fois aux clés et aux valeurs.
// Cependant, si vous avez uniquement besoin d'accéder aux valeurs, vous pouvez utiliser Object.values()qui renvoie un tableau de valeurs :
...
// Il est important de pouvoir lire ce message d'erreur et de comprendre que le problème n'est pas .toUpperCase()mais plutôt l'expression qui
// l'a précédé person.age.
// C'est parce que vous finissez par appeler undefined.toUpperCase()ce qui n'existe pas.
