...
//ce qui la rend plus facile que de s’appuyer sur la .lengthpropriété. Cependant, vous pouvez utiliser l’approche que vous préférez.

// Lorsqu'un index négatif est spécifié, vous commencez à compter à partir de la fin. -1est le dernier
//caractère, -2est celui qui le précède, etc.

// Vous pouvez continuer à utiliser la syntaxe des crochets pour tous les autres cas d'utilisation, sachant que cela language[-1]renvoie
//undéfini. Ainsi, chaque fois que vous souhaitez utiliser un index négatif, vous devez utiliser la .at()méthode.
