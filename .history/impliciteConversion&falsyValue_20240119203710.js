...
// Si vous souhaitez convertir une valeur booléenne en son opposé, vous pouvez utiliser l' !opérateur (opérateur NON logique). Voici
//  comment cela fonctionne:

!true; // false
!false; // true

//Cela se voit souvent dans ifles conditions :
