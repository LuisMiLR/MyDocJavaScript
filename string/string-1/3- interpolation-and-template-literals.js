...
/* Les templates literals rendent le code plus lisible et facilitent l'insertion de variables dans les chaînes de caractères.

L'interpolation en JavaScript est une technique couramment utilisée pour générer des messages dynamiques, des requêtes de base 
de données, des URL dynamiques, et d'autres opérations où des valeurs variables doivent être incorporées dans des chaînes de texte. */
